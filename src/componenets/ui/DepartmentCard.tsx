...
import { IconDotsVertical as EllipsisVertical ,IconUsers, IconTrendingUp} from "@tabler/icons-react";   
		...
		<> 
			<div className=" bg-surface  relative  w-68 flex flex-col justify-evenly border   h-82 rounded-lg px-5 py-5">
				...
				<div className="flex flex-row justify-between   items-center   ">
					<h3 className="font-light text-text-secondary text-base flex flex-row gap-1 "> <IconUsers size={18}/>  Employees</h3>
				...
				<div>
					<div className="flex flex-row justify-between   items-center   ">
						<h2 className="font-light text-text-secondary text-base flex flex-row items-center  gap-1 "><IconTrendingUp size={20}/>Performance</h2>
						<p className="text-text-primary text-base">94%</p>
					</div>
					<div className="ml-2">{/*progress bar here*/}<ProgressBar label={""} value={0} max={100} className={"w-full mt-2"} themeColor={themeColor}/></div>
				</div>
