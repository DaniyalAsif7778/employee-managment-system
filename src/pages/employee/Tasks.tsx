    ...
    <div className="w-full p-6 ">
      ...
      <div className="w-full bg-surface border rounded-xl h-16 mt-8 flex items-center gap-3">
        ...
        <div className="flex items-center gap-3" >
          ...
          <Button text='In Progress' className="text-md w-30 h-10 bg-navbar text-text-secondary rounded-lg"/>
          <Button text='Pending' className="text-md w-25 h-10 bg-navbar text-text-secondary rounded-lg"/>
          <Button text='Done' className="text-md w-20 h-10 bg-navbar text-text-secondary rounded-lg"/>
        </div>
      </div>
    </div>
  );
