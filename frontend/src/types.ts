...
export type TaskStatus = 'pending' | 'in-progress' | 'done' | 'cancelled' | 'overdue' | 'on-hold'
...
export type AnnouncementCategory =
  'general' | 'hr' | 'it' | 'events' | 'policy' | 'urgent' | 'celebration'
...
export type LeaveType =
  'vacation' | 'sick' | 'personal' | 'maternity' | 'paternity' | 'unpaid' | 'bereavement' | 'study'
...
export type EventType =
  'meeting' | 'task' | 'event' | 'reminder' | 'break' | 'training' | 'interview'
